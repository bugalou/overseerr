...
const SidebarLinks: SidebarLinkProps[] = [
  ...
  {
    href: '/news',
    messagesKey: 'news', // <-- Use the new message key
    svgIcon: <NewspaperIcon className="mr-3 h-6 w-6" />, // <-- Use a news icon
    activeRegExp: /^\/news/,
    // No special permissions required, so all users see it
    dataTestId: 'sidebar-menu-news',
  },
];
